...
/**  One client request. The tag `cmd` selects the variant; fields are its inputs. */
export type Command_Deserialize = ({ cmd: "readState" }) & { allowInsecure?: never; count?: never; filename?: never; groupId?: never; intent?: never; lines?: never; maxKb?: never; mode?: never; profile?: never; profileId?: never; span?: never; start?: never; subId?: never; target?: never; text?: never; url?: never; userAgent?: never } | ({ cmd: "readProfiles" }) & { allowInsecure?: never; count?: never; filename?: never; groupId?: never; intent?: never; lines?: never; maxKb?: never; mode?: never; profile?: never; profileId?: never; span?: never; start?: never; subId?: never; target?: never; text?: never; url?: never; userAgent?: never } | 
/**
...
/**  One client request. The tag `cmd` selects the variant; fields are its inputs. */
export type Command_Serialize = ({ cmd: "readState" }) & { allowInsecure?: never; count?: never; filename?: never; groupId?: never; intent?: never; lines?: never; maxKb?: never; mode?: never; profile?: never; profileId?: never; span?: never; start?: never; subId?: never; target?: never; text?: never; url?: never; userAgent?: never } | ({ cmd: "readProfiles" }) & { allowInsecure?: never; count?: never; filename?: never; groupId?: never; intent?: never; lines?: never; maxKb?: never; mode?: never; profile?: never; profileId?: never; span?: never; start?: never; subId?: never; target?: never; text?: never; url?: never; userAgent?: never } | 
/**
 *  The single write path: apply one domain intent to the persisted state. The
 *  handler reads the current state, applies the intent (pure
 *  `kasumi_core::mutate`), runs the write-side middleware chain, persists, and
