...
export const TunEngineSchema = z.union([z.literal("hev"), z.literal("singbox-tun"), z.literal("tun2socks")]);
...
export const AdvancedSettings_SerializeSchema = z.object({
	...
	localPacPort: z.number().nullable().optional(),
...
export const AdvancedSettings_DeserializeSchema = z.object({
	...
	tunTcpRwTimeoutMs: z.number().optional(),
