...
const zh = {
  ...
  "settings.assetAutoUpdateSub": "按计划更新 geosite/geoip",
  "settings.assetUpdateInterval": "更新间隔",
  "settings.assetAutoUpdateWarning": "geo 数据变更时，活动连接会短暂重启以应用更新。",
  "settings.assetIntervalHours": plural("count", { one: "每 # 小时", other: "每 # 小时" }),
  "settings.assetIntervalDays": plural("count", { one: "每 # 天", other: "每 # 天" }),
