...
const zh = {
  ...
  "editor.tlsCipherSuitesHint": "每行一个，或使用逗号分隔",
  "editor.tlsCurvePreferences": "曲线偏好",
  "editor.tlsCurvePreferencesHint": "每行一个，或使用逗号分隔",
  ...
  "settings.launchOnLogin": "登录时启动",
  "settings.launchOnLoginSub": "登录时自动启动 Kasumi Proxy",
  ...
  "settings.singboxFragment": "sing-box 方式",
  "settings.singboxFragmentSub": "上面的字段用于 xray。TCP 分段较慢，建议先尝试 TLS 记录。",
  "settings.singboxFragment.record": "TLS 记录",
  "settings.singboxFragment.segment": "TCP 分段",
  "settings.singboxFragment.both": "两者",
  "settings.tunMtu": "TUN MTU",
  "settings.tunEngineSettings": "引擎设置",
  "settings.tunExclude": "TUN 排除项",
  "settings.tunExcludePh": "172.17.0.0/16, 172.18.0.0/16",
  "settings.tunExcludeHint": "需绕过隧道的 CIDR，每行一个或用逗号分隔（例如 Docker 网络）",
  ...
  "settings.updateAvailable": "有可用版本 {version}",
  ...
  "common.modeShort.proxy": "代理",
  "common.modeShort.direct": "直连",
  "appFilter.default": "默认",
  "appFilter.userProfile": "用户 {n}",
  "settings.coresPreset": "各协议使用的核心",
  "settings.coresPreset.default": "默认",
  "settings.coresPreset.custom": "自定义",
  "settings.logs": "日志",
  "settings.page.routing": "路由",
  "settings.page.cores": "核心与 TUN",
