...
const ru = {
  ...
  "editor.alpn": "ALPN",
  "editor.alpnHint": "По одному значению на строку или через запятую",
  ...
  "editor.tlsCipherSuitesHint": "По одному значению на строку или через запятую",
  "editor.tlsCurvePreferences": "Предпочтения кривых",
  "editor.tlsCurvePreferencesHint": "По одному значению на строку или через запятую",
  ...
  "common.modeShort.proxy": "Прокси",
  "common.modeShort.direct": "Напрямую",
  "appFilter.default": "По умолчанию",
  "appFilter.userProfile": "Профиль {n}",
  ...
  "settings.page.aboutSub": "Версия, обновления, диагностика",
  "settings.rulesCount": plural("count", {
    one: "# правило",
    few: "# правила",
    many: "# правил",
    other: "# правила",
