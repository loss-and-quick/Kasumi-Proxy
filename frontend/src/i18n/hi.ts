...
const hi = {
  ...
  "activity.speedTestComplete": plural("count", {
    one: "स्पीड टेस्ट पूर्ण · # प्रोफ़ाइल",
    other: "स्पीड टेस्ट पूर्ण · # प्रोफ़ाइलें",
  }),
  ...
  "editor.alpn": "ALPN",
  "editor.alpnHint": "प्रति पंक्ति एक आइटम या कॉमा से अलग",
  ...
  "editor.tlsCipherSuitesHint": "प्रति पंक्ति एक आइटम या कॉमा से अलग",
  "editor.tlsCurvePreferences": "कर्व प्राथमिकताएँ",
  "editor.tlsCurvePreferencesHint": "प्रति पंक्ति एक आइटम या कॉमा से अलग",
  ...
  "editor.kcpCwndMultiplier": "KCP cwnd गुणक",
  "editor.kcpMaxSendingWindow": "KCP अधिकतम भेजने वाली विंडो",
  ...
  "editor.wsHeaders": "WS कस्टम हेडर (JSON)",
  ...
  "settings.launchOnLogin": "लॉगिन पर लॉन्च करें",
  "settings.launchOnLoginSub": "साइन इन करने पर Kasumi Proxy स्वतः शुरू करें",
  ...
  "settings.tunExcludeHint": "TUN से बाहर वाले CIDR, एक-एक पंक्ति या अल्पविराम से विभक्त (जैसे Docker नेत्वर)",
  ...
  "settings.appVersion": "संस्करण",
  "settings.checkUpdates": "अपडेट जांचें",
  "settings.updateChecking": "जांच हो रही है…",
  "settings.updateUpToDate": "आप नवीनतम संस्करण पर हैं",
  "settings.updateAvailable": "संस्करण {version} उपलब्ध है",
  ...
  "profiles.confirmDelGroup.body": plural("count", {
    ...
    other: "और इसके # प्रोफ़ाइल स्थायी रूप से हटा दिए जाएंगे।",
  }),
  ...
  "common.modeShort.proxy": "प्रॉक्सी",
  "common.modeShort.direct": "सीधा",
  "appFilter.default": "डिफ़ॉल्ट",
  "appFilter.userProfile": "प्रोफ़ाइल {n}",
  "settings.coresPreset": "हर प्रोटोकॉल के लिए कोर",
  "settings.coresPreset.default": "डिफ़ॉल्ट",
  "settings.coresPreset.custom": "कस्टम",
  "settings.tunEngineFor": "{core} के लिए TUN इंजन",
  "settings.logs": "लॉग",
  "settings.page.routing": "रूटिंग",
  "settings.page.cores": "कोर और TUN",
  ...
  "store.backup.profilesSkipped": plural("count", {
    one: "# अमान्य प्रोफ़ाइल छोड़ी गई",
    other: "# अमान्य प्रोफ़ाइलें छोड़ी गईं",
  }),
