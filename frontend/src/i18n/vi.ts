...
const vi = {
  ...
  "activity.speedTestComplete": plural("count", {
    one: "Kiểm tra tốc độ xong · # hồ sơ",
    other: "Kiểm tra tốc độ xong · # hồ sơ",
  }),
  ...
  "editor.alpn": "ALPN",
  "editor.alpnHint": "Mỗi mục một dòng hoặc ngăn cách bằng dấu phẩy",
  ...
  "editor.tlsCipherSuitesHint": "Mỗi mục một dòng hoặc ngăn cách bằng dấu phẩy",
  "editor.tlsCurvePreferences": "Ưu tiên đường cong",
  "editor.tlsCurvePreferencesHint": "Mỗi mục một dòng hoặc ngăn cách bằng dấu phẩy",
  ...
  "editor.kcpCwndMultiplier": "KCP cwnd hệ số",
  "editor.kcpMaxSendingWindow": "KCP cửa sổ gửi tối đa",
  ...
  "editor.wsHeaders": "WS header tùy chỉnh (JSON)",
  ...
  "settings.launchOnLogin": "Khởi chạy khi đăng nhập",
  "settings.launchOnLoginSub": "Tự động khởi chạy Kasumi Proxy khi bạn đăng nhập",
  ...
  "settings.updateAvailable": "Đã có phiên bản {version}",
  ...
  "common.updateMode": "Chế độ cập nhật",
  ...
  "profiles.confirmDelGroup.body": plural("count", {
    ...
    other: "và # hồ sơ của nhóm sẽ bị xóa vĩnh viễn.",
  }),
  "profiles.confirmDelGroup.cancel": "Hủy",
  "profiles.confirmDelGroup.delete": "Xóa",
  ...
  "common.modeShort.direct": "Trực tiếp",
  "appFilter.default": "Mặc định",
  "appFilter.userProfile": "Hồ sơ {n}",
  ...
  "store.backup.profilesSkipped": plural("count", {
    one: "Đã bỏ qua # hồ sơ không hợp lệ",
    other: "Đã bỏ qua # hồ sơ không hợp lệ",
  }),
