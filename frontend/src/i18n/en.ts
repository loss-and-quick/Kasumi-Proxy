...
const en = {
  ...
  "overview.pendingRestart": "Settings changed — restart to apply",
  "tray.show": "Show",
  "tray.quit": "Quit",
  ...
  "time.unit.m": "m",
  "time.unit.h": "h",
  "interval.pickTitle": "Update interval",
  "interval.ok": "OK",
  ...
  "editor.alpn": "ALPN",
  "editor.alpnHint": "One item per line or comma-separated",
  ...
  "editor.tlsCipherSuitesHint": "One item per line or comma-separated",
  "editor.tlsCurvePreferences": "Curve preferences",
  "editor.tlsCurvePreferencesHint": "One item per line or comma-separated",
  ...
  "editor.kcpCwndMultiplier": "KCP cwnd multiplier",
  "editor.kcpMaxSendingWindow": "KCP max sending window",
  // editor — WS extra
  "editor.wsHeartbeatPeriod": "Heartbeat period (s)",
  "editor.wsHeaders": "WS custom headers (JSON)",
  ...
  "settings.launchOnLogin": "Launch on login",
  "settings.launchOnLoginSub": "Start Kasumi Proxy automatically when you sign in",
  ...
  "common.modeShort.direct": "Direct",
  "appFilter.default": "Default",
  "appFilter.userProfile": "Profile {n}",
