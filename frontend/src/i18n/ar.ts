...
const ar = {
  ...
  "activity.pingComplete": plural("count", {
    ...
    few: "اكتمل الاختبار · # ملفات تعريفية",
    many: "اكتمل الاختبار · # ملفًا تعريفيًا",
    other: "اكتمل الاختبار · # ملف تعريفي",
  }),
  ...
  "activity.speedTestComplete": plural("count", {
    one: "اكتمل اختبار السرعة · ملف تعريفي واحد",
    two: "اكتمل اختبار السرعة · ملفان تعريفيان",
    few: "اكتمل اختبار السرعة · # ملفات تعريفية",
    many: "اكتمل اختبار السرعة · # ملفًا تعريفيًا",
    other: "اكتمل اختبار السرعة · # ملف تعريفي",
  }),
  ...
  "editor.alpn": "ALPN",
  "editor.alpnHint": "عنصر واحد في كل سطر أو مفصول بفواصل",
  ...
  "editor.tlsCipherSuitesHint": "عنصر واحد في كل سطر أو مفصول بفواصل",
  "editor.tlsCurvePreferences": "تفضيلات المنحنى",
  "editor.tlsCurvePreferencesHint": "عنصر واحد في كل سطر أو مفصول بفواصل",
  ...
  "editor.kcpCwndMultiplier": "KCP مضاعف cwnd",
  "editor.kcpMaxSendingWindow": "KCP أقصى نافذة إرسال",
  ...
  "editor.wsHeaders": "رؤوس WS مخصصة (JSON)",
  ...
  "settings.strictRoute": "توجيه صارم (مفتاح إيقاف)",
  ...
  "settings.launchOnLogin": "التشغيل عند تسجيل الدخول",
  "settings.launchOnLoginSub": "تشغيل Kasumi Proxy تلقائيًا عند تسجيل الدخول",
  ...
  "settings.singboxFragment": "طريقة sing-box",
  "settings.singboxFragmentSub": "الحقول أعلاه تنطبق على xray. مقاطع TCP أبطأ؛ جرّب سجلات TLS أولاً.",
  "settings.singboxFragment.record": "سجلات TLS",
  "settings.singboxFragment.segment": "مقاطع TCP",
  "settings.singboxFragment.both": "كلاهما",
  ...
  "settings.appVersion": "الإصدار",
  "settings.checkUpdates": "التحقق من التحديثات",
  "settings.updateChecking": "جارٍ التحقق…",
  "settings.updateUpToDate": "أنت على أحدث إصدار",
  "settings.updateAvailable": "الإصدار {version} متوفر",
  ...
  "profiles.confirmDelGroup.body": plural("count", {
    ...
    two: "وملفاها التعريفيان سيُحذفان نهائيًا.",
    few: "و# ملفات تعريفية ستُحذف نهائيًا.",
    many: "و# ملفًا تعريفيًا سيُحذف نهائيًا.",
    other: "و# ملف تعريفي سيُحذف نهائيًا.",
  }),
  ...
  "common.modeShort.proxy": "وكيل",
  "common.modeShort.direct": "مباشر",
  "appFilter.default": "افتراضي",
  "appFilter.userProfile": "الملف الشخصي {n}",
  ...
  "settings.page.aboutSub": "الإصدار، التحديثات، التشخيص",
  ...
  "store.ping.removeUnreachable": plural("count", {
    ...
    few: "تم حذف # ملفات تعريفية غير متاحة",
    many: "تم حذف # ملفًا غير متاح",
    other: "تم حذف # ملف تعريفي غير متاح",
  }),
  ...
  "store.backup.profilesSkipped": plural("count", {
    one: "تم تخطّي ملف تعريفي واحد غير صالح",
    two: "تم تخطّي ملفين تعريفيين غير صالحين",
    few: "تم تخطّي # ملفات تعريفية غير صالحة",
    many: "تم تخطّي # ملفًا غير صالح",
    other: "تم تخطّي # ملف تعريفي غير صالح",
  }),
