...
const hi = {
  ...
  "settings.assetUpdateMode": "अपडेट मोड",
  "settings.assetMode.auto": "स्वचालित (पहले proxy, फिर direct)",
  "settings.assetMode.proxy": "केवल proxy",
  "settings.assetMode.direct": "केवल direct",
