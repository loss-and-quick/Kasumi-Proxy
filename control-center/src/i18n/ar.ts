...
const ar = {
  ...
  "settings.assetUpdateMode": "وضع التحديث",
  "settings.assetMode.auto": "تلقائي (الوكيل ثم مباشر)",
  "settings.assetMode.proxy": "عبر الوكيل فقط",
  "settings.assetMode.direct": "مباشر فقط",
