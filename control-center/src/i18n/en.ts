...
const en = {
  ...
  "settings.assetUpdateMode": "Update mode",
  "settings.assetMode.auto": "Auto (proxy, then direct)",
  "settings.assetMode.proxy": "Proxy only",
  "settings.assetMode.direct": "Direct only",
